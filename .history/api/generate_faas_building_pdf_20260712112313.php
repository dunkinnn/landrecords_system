...
put($pdf, 150, 340, v($r['building_kind']),11);
put($pdf, 400, 342.5, v($r['building_age']), 11);
put($pdf, 150, 358, v($r['structural_type']), 11);
put($pdf, 400, 360, v($r['storeys']), 11);
put($pdf, 150, 378, v($r['building_permit_no']), 11);
put($pdf, 275, 378, v($r['permit_date']), 11);
put($pdf, 400, 378, num($r['first_floor_area']), 11);
put($pdf, 250, 394.6, v($r['cct_no']), 11);
put($pdf, 400, 395.5, num($r['second_floor_area']), 11);
put($pdf, 250, 412.8, v($r['cert_completion_date']), 11);
put($pdf, 400, 413, num($r['third_floor_area']), 11);
put($pdf, 250, 430.6, v($r['cert_occupancy_date']), 11);
put($pdf, 400, 431, num($r['fourth_floor_area']), 11);
put($pdf, 200, 448.8, v($r['date_constructed']), 11);
put($pdf, 200, 466.6, v($r['date_occupied']), 11);
